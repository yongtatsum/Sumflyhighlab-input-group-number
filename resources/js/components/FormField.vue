    ...
    <default-field :field="field" :errors="errors">
        <template slot="field">
            <div class="flex flex-wrap items-stretch w-full mb-4 relative">
                <div class="flex -mr-px  w-1/6" v-if="position === 'before'">
                ...
                <input
                    ...
                    v-model="value"
                />
                <div class="flex -mr-px w-1/6" v-if="position === 'after'">
    ...
    computed: {
        ...
        classObject() {
            if (this.field.position === 'before') {
                return 'w-5/6 form-control form-input form-input-bordered rounded-l-none'
            }
            else if (this.field.position === 'after') {
                return 'w-5/6 form-control form-input form-input-bordered rounded-r-none'
            }
            else {
